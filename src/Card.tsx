...
const Card = ({style,onclickcard, onkeydown, cardTitle,cardImg,cardContent}:CardProps) => {
  return (
    <div onMouseEnter={() => onkeydown(5)} style={style} className="h-[30rem] hover:text-shadow-violet-950 space-y-2 p-5 
    w-80 rounded-xl shadow-2xl bg-blue-200" onClick={onclickcard}>
